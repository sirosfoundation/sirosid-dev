...
show_status() {
    ...
    echo "  source ${TUNNEL_ENV_FILE}"
    echo "  make restart-with-tunnels"
}
...
# Source this file or use: make restart-with-tunnels
...
EOF
    ...
    info "Run 'make restart-with-tunnels' to reconfigure services with tunnel URLs"
